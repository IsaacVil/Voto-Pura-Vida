...
[benefits] text,
[conditions] text,
[employeerequirement] int,
[locationrequirement] varchar(100),
[sectorrequirement] varchar(100),
...
[requiredvalidators] int DEFAULT ((2)) NOT NULL,
...
CREATE TABLE [dbo].[PV_AIDocumentAnalysisT] (
[analysisDocTypeId] int NOT NULL IDENTITY(1,1),
[name] varchar(50),
PRIMARY KEY ([analysisDocTypeId])
);
...
ALTER TABLE [dbo].[PV_GovernmentApprovals]
ADD CONSTRAINT [FK_PV_GovernmentApprovals_PV_Proposals]
...
ALTER TABLE [dbo].[PV_GovernmentApprovals]
ADD CONSTRAINT [FK_PV_GovernmentApprovals_PV_Users]
...
ALTER TABLE [dbo].[PV_AIProcessingQueue]
ADD CONSTRAINT [FK_PV_AIProcessingQueue_PV_AIConnections]
...
ALTER TABLE [dbo].[PV_AIProcessingQueue]
ADD CONSTRAINT [FK_PV_AIProcessingQueue_PV_AIModels]
FOREIGN KEY ([modelid]) 
...
ALTER TABLE [dbo].[PV_AIProcessingQueue]
ADD CONSTRAINT [FK_PV_AIProcessingQueue_PV_Users]
FOREIGN KEY ([userid]) 
REFERENCES [dbo].[PV_Users]([userid])
...
ADD CONSTRAINT [FK_PV_ProposalValidations_PV_Users]
FOREIGN KEY ([userid]) 
REFERENCES [dbo].[PV_Users]([userid])
...
ALTER TABLE [dbo].[PV_ProposalValidations]
ADD CONSTRAINT [FK_PV_ProposalValidations_PV_ValidatorGroups]
...
ADD CONSTRAINT [FK_PV_Investments_PV_Users]
...
ALTER TABLE [dbo].[PV_Investments]
ADD CONSTRAINT [FK_PV_Investments_PV_Payment]
FOREIGN KEY ([paymentid]) 
REFERENCES [dbo].[PV_Payment]([paymentid])
...
ADD CONSTRAINT [FK_PV_IdentityValidations_PV_Users_Validator]
...
ALTER TABLE [dbo].[PV_IdentityValidations]
ADD CONSTRAINT [FK_PV_IdentityValidations_PV_Users]
FOREIGN KEY ([userid]) 
REFERENCES [dbo].[PV_Users]([userid])
...
ALTER TABLE [dbo].[PV_MultiValidatorApprovals]
ADD CONSTRAINT [FK_PV_MultiValidatorApprovals_PV_Proposals]
FOREIGN KEY ([proposalid]) 
REFERENCES [dbo].[PV_Proposals]([proposalid])
...
ALTER TABLE [dbo].[PV_MultiValidatorApprovals]
ADD CONSTRAINT [FK_PV_MultiValidatorApprovals_PV_Users]
FOREIGN KEY ([userid]) 
REFERENCES [dbo].[PV_Users]([userid])
...
ALTER TABLE [dbo].[PV_AIProposalAnalysis]
ADD CONSTRAINT [FK_PV_AIProposalAnalysis_PV_AIProcessingQueue]
FOREIGN KEY ([queueid]) 
REFERENCES [dbo].[PV_AIProcessingQueue]([queueid])
...
ALTER TABLE [dbo].[PV_ValidatorApprovals]
...
ALTER TABLE [dbo].[PV_ValidatorApprovals]
ADD CONSTRAINT [FK_PV_ValidatorApprovals_PV_MultiValidatorApprovals]
FOREIGN KEY ([multivalidatorapprovalid]) 
REFERENCES [dbo].[PV_MultiValidatorApprovals]([approvalid])
...
ADD CONSTRAINT [FK_mediafileId_mediafiles]
FOREIGN KEY ([mediafileId]) 
REFERENCES [dbo].[PV_mediafiles]([mediafileid])
...
ALTER TABLE [dbo].[PV_AIDocumentAnalysis]
...
ALTER TABLE [dbo].[PV_AIDocumentAnalysis]
ADD CONSTRAINT [FK_PV_AIDocumentAnalysis_PV_AIProcessingQueue]
FOREIGN KEY ([queueid]) 
REFERENCES [dbo].[PV_AIProcessingQueue]([queueid])
...
REFERENCES [dbo].[PV_AIDocumentAnalysisT]([analysisDocTypeId])
