...
-- se usan para invertir y repsrtir dividendos!
...
-- Para esa prupuesta debe tener su execution plan
...
DECLARE @agreement_checksum VARBINARY(256);
        SET @agreement_checksum = HASHBYTES('SHA2_256', CONCAT('Desembolso inicial de la pripuesta'));
