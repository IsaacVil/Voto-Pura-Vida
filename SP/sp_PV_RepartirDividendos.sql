...
IF OBJECT_ID('dbo.sp_PV_RepartirDividendos', 'P') IS NOT NULL
    DROP PROCEDURE dbo.sp_PV_RepartirDividendos;
GO


EXEC sp_PV_RepartirDividendos
    @proposalid = 1,
    @processedby = 1, -- quien la procesa, probablemente el user dueño de la propuesta
    @paymentmethodid = 1,
    @availablemethodid = 1,
    @currencyid = 1,
    @exchangerateid = 1
